...
const ITALY_TEAMS = [
  ...
  },
  {
    ...
    players: [
      ...
      withStats(player("Alessandro Di Dio", "DEF", 69, 72, 86, 76, 25), { matches: 3, goals: 1 }),
  ...
  },
  {
    ...
    players: [
      ...
      withStats(player("Lyncoln Oliveira", "DEF", 73, 80, 87, 78, 24), { matches: 3, goals: 4, assists: 1 }),
      ...
      withStats(player("Cristhian Canhoto", "MID", 95, 92, 90, 88, 35), { matches: 3, assists: 2 }),
...
const MEXICO_TEAMS = [
  {
    ...
    players: [
      player("Erik Fraire", "GK", 63, 73, 77, 79, 30),
      player("Nelson Velandia", "GK", 65, 66, 70, 71, 27),
      player("Denilson Lobón", "DEF", 87, 84, 95, 86, 22),
      player("Martín Cani Rodríguez", "DEF", 85, 83, 95, 90, 33),
      player("Patricio Pato Arias", "DEF", 74, 72, 83, 78, 23),
      player("Brayan González", "MID", 84, 96, 90, 87, 20),
      player("Brayan Hernández", "MID", 83, 87, 86, 93, 27),
      player("Brihan Gutiérrez", "MID", 85, 89, 81, 84, 22),
      player("Daviz Junco", "MID", 74, 78, 74, 78, 35),
      player("Obed Martínez", "MID", 66, 73, 72, 68, 26),
      player("Axur Quintero", "ATT", 89, 82, 84, 75, 21),
      player("Diego Martínez", "ATT", 89, 96, 85, 87, 25),
      player("Jacob Lobo Morales", "ATT", 90, 88, 86, 84, 21)
    ]
  },
  {
    ...
    players: [
      player("Felipe Urán", "GK", 74, 73, 87, 81, 27),
      player("Simón Duque", "GK", 72, 75, 83, 84, 29),
      player("Andrés Osorno", "DEF", 70, 62, 77, 68, 25),
      player("Cristian Hernández", "DEF", 84, 84, 92, 90, 24),
      player("David Loaiza", "DEF", 83, 85, 97, 90, 22),
      player("Juan Tilano", "DEF", 78, 85, 90, 91, 33),
      player("Kevin Mejía", "DEF", 67, 63, 68, 68, 24),
      player("Marlon Ramírez", "DEF", 89, 89, 97, 91, 27),
      player("Alexis Gómez", "ATT", 81, 82, 81, 72, 18),
      player("Angellot Caro", "ATT", 90, 81, 76, 76, 21),
      player("Jhon Palacios", "ATT", 89, 83, 85, 74, 30),
      player("Julio Perea", "ATT", 78, 79, 69, 66, 26),
      player("Maicol Hernández", "ATT", 85, 93, 88, 81, 27)
    ]
  },
  {
    ...
    players: [
      player("Armando Chávez", "GK", 74, 72, 89, 85, 35),
      player("Bernaldino Valdovinos", "GK", 56, 65, 69, 68, 29),
      player("Hugo Murga", "GK", 76, 81, 84, 92, 21),
      player("César Romo", "DEF", 60, 66, 78, 67, 25),
      player("Edson González", "DEF", 74, 76, 76, 77, 24),
      player("Jorge Escamilla", "DEF", 71, 70, 81, 73, 24),
      player("Marlon Castillo", "DEF", 63, 72, 72, 72, 21),
      player("Mixtly Cruz", "DEF", 76, 70, 85, 82, 23),
      player("Adriano Nunes", "MID", 76, 82, 71, 80, 26),
      player("Ángel Ayala", "MID", 78, 89, 80, 84, 20),
      player("Brandon Magaña", "MID", 76, 84, 72, 83, 26),
      player("Edder Vargas", "MID", 75, 80, 72, 77, 29),
      player("Fausto Alemán", "MID", 80, 76, 72, 80, 30),
      player("José Askenazi", "MID", 88, 92, 92, 91, 26),
      player("Roberto Uribe", "MID", 91, 87, 78, 85, 19),
      player("Luis Valdés", "MID", 82, 91, 86, 92, 20),
      player("Salvador Navarro", "MID", 72, 77, 70, 74, 31),
      player("Baruc Ochoa", "ATT", 97, 95, 91, 82, 23),
      player("Diego Velázquez", "ATT", 80, 78, 71, 71, 22),
      player("Miguel Morales", "ATT", 90, 90, 81, 78, 28)
    ]
  },
  {
    ...
    players: [
      player("Baruc Mateos", "GK", 83, 81, 97, 97, 27),
      player("Iván Muñoz", "GK", 60, 60, 68, 75, 21),
      player("Jesús Carbajal", "GK", 69, 79, 81, 86, 25),
      player("Daniel Mendoza", "DEF", 62, 60, 72, 70, 27),
      player("Erick Madrigal", "DEF", 69, 68, 87, 80, 20),
      player("Jairo Tapie", "DEF", 85, 83, 95, 84, 25),
      player("Alejandro Maro Ortega", "MID", 80, 83, 75, 75, 26),
      player("Diego Franco", "MID", 78, 81, 67, 79, 28),
      player("Erick Guzmán", "MID", 74, 74, 75, 74, 33),
      player("José Hernández", "MID", 66, 79, 66, 70, 32),
      player("Pabel Montes", "MID", 75, 85, 73, 76, 26),
      player("Pablo Gómez", "MID", 84, 95, 86, 96, 23),
      player("Andres Valiente", "MID", 73, 75, 69, 77, 23),
      player("Kevin Cardona", "ATT", 68, 76, 68, 62, 20),
      player("Jhon Miranda", "ATT", 86, 83, 83, 73, 29)
    ]
  },
  {
    ...
    players: [
      player("Jair Peláez", "GK", 76, 76, 88, 79, 18),
      player("Omar Láscari", "GK", 62, 61, 76, 69, 29),
      player("Said Zamora", "GK", 66, 60, 76, 74, 27),
      player("Adrián Mora", "DEF", 60, 68, 73, 69, 18),
      player("Alejandro Chimal", "DEF", 91, 88, 97, 88, 24),
      player("Eduardo Velarde", "DEF", 65, 73, 78, 69, 25),
      player("Juan Carlos Silva", "DEF", 67, 60, 70, 67, 24),
      player("Miguel Lizardo", "DEF", 82, 76, 86, 82, 28),
      player("Rafael Cid", "DEF", 78, 71, 83, 85, 23),
      player("Albano Rodríguez", "DEF", 91, 92, 97, 91, 21),
      player("Abraham Morales", "MID", 85, 92, 88, 91, 35),
      player("Gerardo Ramírez", "MID", 84, 89, 81, 88, 22),
      player("Gustavo Furby Guillén", "MID", 71, 76, 64, 65, 18),
      player("Alain Villanueva", "MID", 81, 82, 70, 85, 18),
      player("Carlos Mata", "MID", 67, 68, 61, 67, 21),
      player("Abel Vega", "ATT", 87, 89, 88, 81, 24),
      player("Isaac Zepeda", "ATT", 94, 85, 87, 80, 32),
      player("Morrison Palma", "ATT", 94, 89, 84, 78, 25),
      player("Patricio Zerecero", "ATT", 80, 79, 70, 72, 28),
      player("Yudier Prado", "ATT", 80, 73, 65, 62, 29)
    ]
  },
  {
    ...
    players: [
      player("Erik Lugo", "GK", 79, 88, 93, 89, 28),
      player("Jeancob Ramírez", "GK", 66, 70, 75, 72, 22),
      player("Donovan Hernández", "GK", 67, 67, 72, 72, 33),
      player("Dago Campari", "DEF", 66, 75, 78, 72, 24),
      player("Mauricio Reyna", "DEF", 84, 84, 95, 91, 26),
      player("Alonso Ferreira", "DEF", 73, 70, 78, 73, 25),
      player("Christopher Pedraza", "MID", 83, 84, 73, 76, 24),
      player("Edson Trejo", "MID", 90, 90, 84, 88, 33),
      player("Gonzalo Lescano", "MID", 69, 66, 69, 70, 27),
      player("Santiago Rotemberg", "MID", 89, 96, 82, 88, 22),
      player("Aaron Martínez", "ATT", 73, 77, 71, 68, 21),
      player("Alberto García", "ATT", 74, 73, 72, 68, 24),
      player("Facu Romero", "ATT", 92, 96, 87, 84, 29),
      player("Tomás Sandoval", "ATT", 68, 71, 68, 61, 32)
    ]
  },
  {
    ...
    players: [
      player("James Hernández", "GK", 70, 70, 83, 81, 30),
      player("Julio Torres", "GK", 81, 85, 85, 92, 22),
      player("Alan Mendoza", "DEF", 73, 76, 87, 77, 30),
      player("Daniel Ríos", "DEF", 84, 88, 92, 92, 20),
      player("Erik Vera", "DEF", 75, 74, 87, 77, 22),
      player("Brayam Nazarit", "MID", 82, 84, 82, 82, 34),
      player("David Ortiz", "MID", 91, 95, 87, 92, 26),
      player("Jesús Chuy Pérez", "MID", 78, 82, 77, 74, 22),
      player("Jorge Meléndez", "MID", 65, 69, 67, 72, 28),
      player("Juan Ramírez", "MID", 91, 88, 79, 86, 25),
      player("Ricardo Valencia", "MID", 72, 75, 70, 72, 22),
      player("Alejandro Sanchez", "MID", 84, 86, 73, 77, 24),
      player("Devin Vega", "MID", 77, 75, 73, 78, 25),
      player("Diego Abella", "ATT", 92, 84, 77, 79, 27)
    ]
  },
  {
    ...
    players: [
      player("Carlos Escalona", "GK", 74, 77, 87, 86, 26),
      player("Cristian Hernández", "GK", 72, 78, 85, 90, 23),
      player("Alexis López", "DEF", 69, 59, 69, 73, 27),
      player("Tonatiuh Mejía", "DEF", 90, 92, 97, 97, 27),
      player("Uriel Zuart", "DEF", 62, 68, 74, 74, 28),
      player("Álvaro Bocanegra", "MID", 84, 90, 80, 86, 26),
      player("Christian Lagunas", "MID", 76, 80, 72, 76, 31),
      player("Irvin Mojica", "MID", 89, 94, 87, 91, 21),
      player("Jesús López", "MID", 71, 69, 65, 67, 19),
      player("Juan Cisneros", "MID", 66, 74, 69, 66, 30),
      player("Román Ramírez", "MID", 92, 95, 86, 91, 27),
      player("Alan Sanchez", "MID", 91, 92, 81, 93, 23),
      player("Gustavo Miranda", "MID", 85, 83, 80, 81, 24),
      player("Salvador Navarro", "MID", 83, 82, 80, 82, 30),
      player("Donovan Alba", "ATT", 72, 71, 60, 60, 26),
      player("Genaro Castillo", "ATT", 80, 81, 81, 79, 34),
      player("Leo Makina Herrlein", "ATT", 88, 90, 83, 83, 18),
      player("José Vizcarra", "ATT", 94, 91, 88, 83, 32)
    ]
  },
  {
    ...
    players: [
      player("Moisés Dabbah", "GK", 68, 70, 83, 81, 25),
      player("Daniel Quiroz", "GK", 74, 70, 84, 79, 29),
      player("Josecarlos Van Rankin", "DEF", 75, 76, 87, 83, 22),
      player("Carlos Camello Valdez", "DEF", 76, 72, 76, 73, 22),
      player("Aldair Giorgana", "MID", 94, 95, 84, 88, 23),
      player("Eder Giorgana", "MID", 72, 76, 68, 82, 25),
      player("Christian Gimenez", "MID", 82, 90, 83, 87, 24),
      player("Fernando Morales", "MID", 79, 74, 76, 78, 18),
      player("Hugo Rodríguez", "MID", 92, 87, 81, 84, 28),
      player("Ángel Curry Castro", "MID", 80, 83, 69, 77, 25),
      player("Michelle Chucky Castro", "MID", 67, 77, 73, 70, 35),
      player("Mauricio Huitrón", "MID", 84, 92, 88, 87, 18),
      player("Pablo Barrera", "MID", 77, 81, 79, 82, 23),
      player("Aarón Del Real", "MID", 72, 84, 79, 80, 23),
      player("Santiago Lagarde", "ATT", 90, 90, 88, 81, 28),
      player("Eddie Sánchez", "ATT", 82, 87, 79, 71, 25),
      player("César Vallejo", "ATT", 90, 82, 79, 70, 33)
    ]
  },
  {
    ...
    players: [
      player("Antonio Monterde", "GK", 80, 74, 91, 91, 24),
      player("David Acuña", "DEF", 80, 72, 80, 77, 20),
      player("Gustavo Ramos", "DEF", 76, 80, 88, 85, 21),
      player("Iván Monroy", "DEF", 76, 76, 80, 79, 27),
      player("Kevin Valdez", "DEF", 73, 72, 81, 77, 32),
      player("Rodrigo González", "DEF", 83, 75, 92, 81, 27),
      player("Irving Zurita", "MID", 68, 70, 65, 71, 28),
      player("Luis Amador", "MID", 92, 90, 88, 89, 31),
      player("Obed Martínez", "MID", 91, 95, 83, 89, 21),
      player("Óscar Gómez", "MID", 71, 83, 75, 80, 23),
      player("Yair Arias", "MID", 67, 75, 67, 72, 24),
      player("Gerardo Chávez", "MID", 76, 84, 76, 88, 26),
      player("Irving Rodríguez", "MID", 88, 93, 85, 84, 28),
      player("José Juan Vázquez", "MID", 74, 76, 70, 81, 28),
      player("Diego Rodríguez", "ATT", 85, 80, 71, 67, 25),
      player("José Rochín", "ATT", 90, 83, 82, 72, 34),
      player("Josenildo Santos", "ATT", 76, 71, 67, 61, 23),
      player("Marco Granados", "ATT", 80, 73, 66, 69, 35),
      player("Paulo Santos", "ATT", 86, 88, 84, 83, 24)
    ]
  },
  {
    ...
    players: [
      player("Jonathan Sánchez", "GK", 73, 78, 92, 88, 30),
      player("Matías Herrera", "GK", 65, 68, 74, 70, 22),
      player("Obeth Rojas", "GK", 60, 64, 72, 81, 33),
      player("Eder López", "DEF", 63, 63, 76, 77, 26),
      player("Ezequiel Luna", "DEF", 90, 81, 97, 91, 20),
      player("Héctor de la Fuente", "DEF", 72, 81, 89, 82, 28),
      player("Juande Martínez", "DEF", 70, 67, 79, 70, 23),
      player("Lautaro Martínez", "DEF", 84, 81, 90, 84, 35),
      player("Matias Rojas", "DEF", 79, 80, 97, 88, 18),
      player("Donovan Martínez", "MID", 83, 87, 84, 89, 19),
      player("Juan Araya", "MID", 86, 94, 80, 86, 26),
      player("Mathías Vidangossy", "MID", 91, 94, 82, 86, 28),
      player("Manu Lanzarote", "MID", 77, 84, 79, 83, 24),
      player("Alexis Silva", "ATT", 81, 86, 78, 71, 26),
      player("Alfonso Nieto", "ATT", 87, 77, 73, 74, 22)
    ]
  },
  {
    ...
    players: [
      player("Óscar Medina", "GK", 78, 78, 88, 95, 30),
      player("Jorge Lima", "GK", 73, 75, 78, 85, 29),
      player("Luis Huerta", "GK", 64, 63, 76, 68, 18),
      player("Erick Sámano", "DEF", 70, 68, 71, 68, 25),
      player("George Corral", "DEF", 76, 73, 85, 83, 25),
      player("Sebastián Sáez", "DEF", 82, 80, 87, 77, 27),
      player("Andrés Suárez", "MID", 88, 84, 81, 88, 27),
      player("Gerson García", "MID", 93, 94, 83, 89, 23),
      player("Hatzel Roque", "MID", 72, 76, 76, 82, 34),
      player("José Shaggy Martínez", "MID", 70, 82, 72, 74, 27),
      player("Luis Olascoaga", "MID", 66, 70, 68, 74, 26),
      player("Cristian González", "ATT", 74, 72, 69, 68, 29),
      player("Miguel Rebollo", "ATT", 80, 87, 81, 72, 27),
      player("Roberto Pérez", "ATT", 79, 72, 67, 68, 22)
    ]
  },
];
